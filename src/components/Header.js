...
export const Header = () => {
    ...
    const activeClass = 'ext-base block py-2 pl-3 pr-4 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white';
    ...
    return (
        <header>
            <nav className="bg-white border-b-2 border-gray-200 dark:bg-gray-900 dark:border-b-1 dark:border-gray-900 py-4 px-2">
              ...
              <div className="flex md:order-2">
                <button onClick={() => setDarkMode(!darkMode)} id="theme-toggle" type="button" className="text-gray-500 dark:text-gray-400 border border-gray-200 dark:border dark:border-b-900 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2 mr-2">
